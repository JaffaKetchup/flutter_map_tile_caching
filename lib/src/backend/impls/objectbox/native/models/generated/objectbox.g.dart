  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    ObjectBoxRecovery: obx_int.EntityDefinition<ObjectBoxRecovery>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final refIdParam = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          6,
          0,
        ...
        final startTileParam = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          16,
          0,
        );
        final endTileParam = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          18,
          0,
        ...
        final regionParam = obx.ToOne<ObjectBoxRecoveryRegion>(
          targetId: const fb.Int64Reader().vTableGet(buffer, rootOffset, 46, 0),
        );
    ...
    ObjectBoxStore: obx_int.EntityDefinition<ObjectBoxStore>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final maxLengthParam = const fb.Int64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          18,
        );
        ...
        final hitsParam = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          12,
          0,
        );
        final missesParam = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          14,
          0,
    ...
    ObjectBoxTile: obx_int.EntityDefinition<ObjectBoxTile>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        obx_int.InternalToManyAccess.setRelInfo<ObjectBoxTile>(
          object.stores,
          store,
          obx_int.RelInfo<ObjectBoxTile>.toMany(1, object.id),
        );
        return object;
      },
    ),
    ...
    ObjectBoxRecoveryRegion: obx_int.EntityDefinition<ObjectBoxRecoveryRegion>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        final buffer = fb.BufferContext(fbData);
        final rootOffset = buffer.derefObject(0);
        final typeIdParam = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          6,
          0,
        );
        final rectNwLatParam = const fb.Float64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          8,
        );
        final rectNwLngParam = const fb.Float64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          10,
        );
        final rectSeLatParam = const fb.Float64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          12,
        );
        final rectSeLngParam = const fb.Float64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          14,
        );
        final circleCenterLatParam = const fb.Float64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          16,
        );
        final circleCenterLngParam = const fb.Float64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          18,
        );
        final circleRadiusParam = const fb.Float64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          20,
        );
        final lineLatsParam = const fb.ListReader<double>(
          fb.Float64Reader(),
          lazy: false,
        ).vTableGetNullable(buffer, rootOffset, 22);
        final lineLngsParam = const fb.ListReader<double>(
          fb.Float64Reader(),
          lazy: false,
        ).vTableGetNullable(buffer, rootOffset, 24);
        final lineRadiusParam = const fb.Float64Reader().vTableGetNullable(
          buffer,
          rootOffset,
          26,
        );
        final customPolygonLatsParam = const fb.ListReader<double>(
          fb.Float64Reader(),
          lazy: false,
        ).vTableGetNullable(buffer, rootOffset, 28);
        final customPolygonLngsParam = const fb.ListReader<double>(
          fb.Float64Reader(),
          lazy: false,
...
class ObjectBoxRecovery_ {
  ...
  static final id = obx.QueryIntegerProperty<ObjectBoxRecovery>(
    _entities[0].properties[0],
  );

  /// See [ObjectBoxRecovery.refId].
  static final refId = obx.QueryIntegerProperty<ObjectBoxRecovery>(
    _entities[0].properties[1],
  );

  /// See [ObjectBoxRecovery.storeName].
  static final storeName = obx.QueryStringProperty<ObjectBoxRecovery>(
    _entities[0].properties[2],
  );

  /// See [ObjectBoxRecovery.creationTime].
  static final creationTime = obx.QueryDateProperty<ObjectBoxRecovery>(
    _entities[0].properties[3],
  );

  /// See [ObjectBoxRecovery.minZoom].
  static final minZoom = obx.QueryIntegerProperty<ObjectBoxRecovery>(
    _entities[0].properties[4],
  );

  /// See [ObjectBoxRecovery.maxZoom].
  static final maxZoom = obx.QueryIntegerProperty<ObjectBoxRecovery>(
    _entities[0].properties[5],
  );

  /// See [ObjectBoxRecovery.startTile].
  static final startTile = obx.QueryIntegerProperty<ObjectBoxRecovery>(
    _entities[0].properties[6],
  );

  /// See [ObjectBoxRecovery.endTile].
  static final endTile = obx.QueryIntegerProperty<ObjectBoxRecovery>(
...
class ObjectBoxStore_ {
  ...
  static final id = obx.QueryIntegerProperty<ObjectBoxStore>(
    _entities[1].properties[0],
  );

  /// See [ObjectBoxStore.name].
  static final name = obx.QueryStringProperty<ObjectBoxStore>(
    _entities[1].properties[1],
  );

  /// See [ObjectBoxStore.length].
  static final length = obx.QueryIntegerProperty<ObjectBoxStore>(
    _entities[1].properties[2],
  );

  /// See [ObjectBoxStore.size].
  static final size = obx.QueryIntegerProperty<ObjectBoxStore>(
    _entities[1].properties[3],
  );

  /// See [ObjectBoxStore.hits].
  static final hits = obx.QueryIntegerProperty<ObjectBoxStore>(
    _entities[1].properties[4],
  );

  /// See [ObjectBoxStore.misses].
  static final misses = obx.QueryIntegerProperty<ObjectBoxStore>(
    _entities[1].properties[5],
  );

  /// See [ObjectBoxStore.metadataJson].
  static final metadataJson = obx.QueryStringProperty<ObjectBoxStore>(
    _entities[1].properties[6],
  );

  /// See [ObjectBoxStore.maxLength].
  static final maxLength = obx.QueryIntegerProperty<ObjectBoxStore>(
...
class ObjectBoxTile_ {
  ...
  static final id = obx.QueryIntegerProperty<ObjectBoxTile>(
    _entities[2].properties[0],
  );

  /// See [ObjectBoxTile.url].
  static final url = obx.QueryStringProperty<ObjectBoxTile>(
    _entities[2].properties[1],
  );

  /// See [ObjectBoxTile.bytes].
  static final bytes = obx.QueryByteVectorProperty<ObjectBoxTile>(
    _entities[2].properties[2],
  );

  /// See [ObjectBoxTile.lastModified].
  static final lastModified = obx.QueryDateProperty<ObjectBoxTile>(
...
class ObjectBoxRoot_ {
  ...
  static final id = obx.QueryIntegerProperty<ObjectBoxRoot>(
    _entities[3].properties[0],
  );

  /// See [ObjectBoxRoot.length].
  static final length = obx.QueryIntegerProperty<ObjectBoxRoot>(
    _entities[3].properties[1],
  );

  /// See [ObjectBoxRoot.size].
  static final size = obx.QueryIntegerProperty<ObjectBoxRoot>(
