...
void main() {
  ...
  group('Custom Polygon Region', () {
    ...
    test(
      'Count By Counter',
      () =>
          expect(TilesCounter.customPolygonTiles(customPolygonRegion1), 15962),
    );
    ...
    test(
      ...
      () =>
          expect(TilesCounter.customPolygonTiles(customPolygonRegion2), 712096),
    );

    test(
      'Count By Generator (Compare to Rectangle Region)',
      () async => expect(await countByGenerator(customPolygonRegion2), 712096),
    );
